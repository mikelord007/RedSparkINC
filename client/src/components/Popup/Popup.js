...
const Popup = ({dispArray,CloseButtonFn,GreenBool,GreenBtnFn, GreenBtnFnArgs, GreenBtnContent, doDispatch, disableButton, height, setModal}) => {
    const dispatch = useDispatch();


    return (
        <>
            <div id="modal-cover" onClick={() => CloseButtonFn(false)}>
            </div>
